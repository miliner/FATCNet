...
from networks.vit_seg_modeling import FATCNet
...
if __name__ == "__main__":
    ...
    args.exp = 'T2end-END-' + dataset_name + str(args.img_size)
    snapshot_path = "./model/{}/{}".format(args.exp, '0115-234-AttFuse+se*(16-2)+3end')
    snapshot_path = snapshot_path if args.is_pretrain else snapshot_path
    ...
    net = FATCNet(config_vit, img_size=args.img_size, num_classes=config_vit.n_classes).cuda()
    print(net)
